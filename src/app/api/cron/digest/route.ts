...
export async function GET(request: Request) {
  // Auth runs first and in isolation, before any env-dependent business
  // logic, so a misconfigured/unset CRON_SECRET never leaks env detail to
  // an unauthenticated caller (see requireCronAuth).
